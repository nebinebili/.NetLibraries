...
namespace FluentValidationApp.Web.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Age,Name,Email,BirthDay")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Age,Name,Email")] Customer customer)
        {
            if (id != customer.Id)
            {
                return NotFound();
